...
const Navbar = () => {
    ...
    return(
        <div className="">
            <div className="bg-blue-700 fixed top-0 left-0 right-0 opacity-100">
                <header className="text-white body-font makebold">
                    <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                        ...
                        <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center">
                            ...
                            <Link className="mr-5 hover:text-gray-900" to="about" smooth={true} duration={1000}>About Us</Link>
                            <Link className="mr-5 hover:text-gray-900" to="mission" smooth={true} duration={1000}>Mission</Link>
                            <Link className="mr-5 hover:text-gray-900" to="virtue" smooth={true} duration={1000}>Virtues</Link>
                        </nav>
                    </div>
                </header>
            </div>
